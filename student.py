...
class Student:
    def __init__(self, root):
        ...
        img_left = Image.open(r"D:\Mini Project\imAGES\details.jpeg")
        ...
        dep_combo["values"]=("Select department","AIML","DS","CSBS")
        dep_combo.current(0)
        ...
        img_right = Image.open(r"D:\Mini Project\imAGES\Premium Photo _ Group of students discussing project.png")
    ...
    def add_data(self):
        if self.var_dep.get() == "Select Department" or self.var_std_name.get() == "" or self.var_std_id.get() == "":
            ...
            try:
                conn = mysql.connector.connect(host="localhost", username="root", password="Nikhil@1311", database="face_recognizer")
